    ...
    <div className="mt-6 bg-gray-50 rounded-lg p-4">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="text-center">
          ...
          <p className="text-2xl font-semibold text-green-600">{presentDays}</p>
        </div>
        <div className="text-center">
          <p className="text-sm text-gray-500">Absent Days</p>
          <p className="text-2xl font-semibold text-red-600">{absentDays}</p>
        </div>
        <div className="text-center">
          <p className="text-sm text-gray-500">Attendance Rate</p>
          <p className="text-2xl font-semibold text-indigo-600">{attendanceRate}%</p>
        </div>
        <div className="text-center">
          <p className="text-sm text-gray-500">Last Present</p>
